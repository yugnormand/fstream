...
class cClear:
    ...
    def main(self, env):
        ...
        if (env == 'urlresolver'):
            ...
            cached_DB = "special://home/userdata/addon_data/plugin.video.fstream/fstream.db"
            # important seul xbmcvfs peux lire le special
            try:
            ...
            class XMLDialog(xbmcgui.WindowXMLDialog):
                ...
                def onInit(self):
                    ...
                    for aPlugin in aPlugins:
                        ...
                        icon = "special://home/addons/plugin.video.fstream/resources/art/sites/%s.png" % sPluginName
