...
# chaines
channels = {
    116: ['bein Sports 1', 'ddh2/premium116/tracks-v1a1/mono.m3u8', 'https://images.beinsports.com/n43EXNeoR62GvZlWW2SXKuQi0GA=/788708-HD1.png'],
    117: ['bein Sports 2', 'ddh2/premium117/tracks-v1a1/mono.m3u8', 'https://images.beinsports.com/dZ2ESOsGlqynphSgs7MAGLwFAcg=/788711-HD2.png'],
    118: ['bein Sports 3', 'ddh2/premium118/tracks-v1a1/mono.m3u8', 'https://images.beinsports.com/G4M9yQ3f4vbFINuKGIoeJQ6kF_I=/788712-HD3.png'],
    119: ['RMC Sport 1', 'ddh2/premium119/tracks-v1a1/mono.m3u8', 'https://i0.wp.com/www.planetecsat.com/wp-content/uploads/2018/07/RMC_SPORT1_PNG_500x500px.png?w=500&ssl=1'],
    120: ['RMC Sport 2', 'ddh1/premium120/tracks-v1a1/mono.m3u8', 'https://i0.wp.com/www.planetecsat.com/wp-content/uploads/2018/07/RMC_SPORT2_PNG_500x500px.png?fit=500%2C500&ssl=1'],
    121: ['Canal+', 'ddh2/premium121/tracks-v1a1/mono.m3u8', 'https://thumb.canalplus.pro/http/unsafe/epg.canal-plus.com/mycanal/img/CHN43FN/PNG/213X160/CHN43FB_301.PNG'],
    122: ['Canal+ Sport', 'ddh2/premium122/tracks-v1a1/mono.m3u8', 'https://thumb.canalplus.pro/http/unsafe/epg.canal-plus.com/mycanal/img/CHN43FN/PNG/213X160/CHN43FB_177.PNG'],
    463: ['Canal+ Foot', 'ddy4/premium463/tracks-v1a1/mono.m3u8', 'https://thumb.canalplus.pro/bran/unsafe/870x486/image/62dab6a90b84c/uploads/media/C+FOOT_213x160.png'],
    645: ["L'équipe", 'ddy5/premium645/tracks-v1a1/mono.m3u8', 'https://upload.wikimedia.org/wikipedia/commons/4/4a/L%27Equipe_logo.png'],
    318: ["Golf Channel USA", 'ddy3/premium318/tracks-v1a1/mono.m3u8', 'https://www.golfchannel.fr/upload/media/golf-channel-600af6fe955c3.png'],
    494: ['bein Sports MAX 4', 'ddy5/premium494/tracks-v1a1/mono.m3u8', 'https://images.beinsports.com/owLVmBRH9cHk6K9JSocpTw0Oc4E=/788713-4MAX.png'],
    495: ['bein Sports MAX 5', 'ddy5/premium495/tracks-v1a1/mono.m3u8', 'https://images.beinsports.com/FE2dOGMxn1waqAFYxqsGxXKkvCo=/788714-5MAX.png'],
    496: ['bein Sports MAX 6', 'ddy5/premium496/tracks-v1a1/mono.m3u8', 'https://images.beinsports.com/beNacZewwA5WqFglPAwOaD4n5QA=/788715-6MAX.png'],
    497: ['bein Sports MAX 7', 'ddy5/premium497/tracks-v1a1/mono.m3u8', 'https://images.beinsports.com/6IXXUorOrK_n756SjT6a2Ko7jiM=/788716-7MAX.png'],
    498: ['bein Sports MAX 8', 'ddy5/premium498/tracks-v1a1/mono.m3u8', 'https://images.beinsports.com/6aOfeAugcgMy93nrOfk8NAacALs=/788717-8MAX.png'],
    499: ['bein Sports MAX 9', 'ddy5/premium499/tracks-v1a1/mono.m3u8', 'https://images.beinsports.com/etM_TIm1DmhWr0TZ_CbWGJvaTdQ=/788718-9MAX.png'],
    500: ['bein Sports MAX 10', 'ddy5/premium500/tracks-v1a1/mono.m3u8', 'https://images.beinsports.com/LxFG3ZG88jlFsOyWo_C7o4mdY7M=/788719-10MAX.png']
    }
...
#    prefixUrl = 'https://ddh1.mizhls.ru/ddh1/premium322/tracks-v1a1/mono.m3u8'
    ...
    sUrl = URL_LINK + 'ddh2/premium%s/tracks-v1a1/mono.m3u8' % channel
    sUrl = sUrl + '|referer=https://weblivehdplay.ru/'
    hosterLienDirect.setDisplayName(sDisplayTitle)
    hosterLienDirect.setFileName(sDisplayTitle)
    oHosterGui.showHoster(oGui, hosterLienDirect, sUrl, '')
    ...
    sUrl = URL_LINK + 'ddy2/premium%s/tracks-v1a1/mono.m3u8' % channel
    sUrl = sUrl + '|referer=https://weblivehdplay.ru/'
    hosterLienDirect.setDisplayName(sDisplayTitle)
    hosterLienDirect.setFileName(sDisplayTitle)
    oHosterGui.showHoster(oGui, hosterLienDirect, sUrl, '')
    ...
    sUrl = URL_LINK + 'ddy3/premium%s/tracks-v1a1/mono.m3u8' % channel
    sUrl = sUrl + '|referer=https://weblivehdplay.ru/'
    hosterLienDirect.setDisplayName(sDisplayTitle)
    hosterLienDirect.setFileName(sDisplayTitle)
    oHosterGui.showHoster(oGui, hosterLienDirect, sUrl, '')
    ...
    sUrl = URL_LINK + 'ddy4/premium%s/tracks-v1a1/mono.m3u8' % channel
    sUrl = sUrl + '|referer=https://weblivehdplay.ru/'
    hosterLienDirect.setDisplayName(sDisplayTitle)
    hosterLienDirect.setFileName(sDisplayTitle)
    oHosterGui.showHoster(oGui, hosterLienDirect, sUrl, '')
    ...
    sUrl = URL_LINK + 'ddy5/premium%s/tracks-v1a1/mono.m3u8' % channel
    sUrl = sUrl + '|referer=https://weblivehdplay.ru/'
    hosterLienDirect.setDisplayName(sDisplayTitle)
    hosterLienDirect.setFileName(sDisplayTitle)
    oHosterGui.showHoster(oGui, hosterLienDirect, sUrl, '')
    ...
    sUrl = URL_LINK + 'esx3/premium%s/tracks-v1a1/mono.m3u8' % channel
    sUrl = sUrl + '|referer=https://weblivehdplay.ru/'
    hosterLienDirect.setDisplayName(sDisplayTitle)
    hosterLienDirect.setFileName(sDisplayTitle)
    oHosterGui.showHoster(oGui, hosterLienDirect, sUrl, '')
