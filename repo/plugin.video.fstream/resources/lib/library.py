...
class cLibrary:
    ...
    def __init__(self):
        ...
        if not self.__sMovieFolder:
            self.__sMovieFolder = 'special://userdata/addon_data/plugin.video.fstream/Films'
        ...
        if not self.__sTVFolder:
            self.__sTVFolder = 'special://userdata/addon_data/plugin.video.fstream/Series'
    ...
    def setLibrary(self):
        ...
        sLink = 'plugin://plugin.video.fstream/?function=play&site=cHosterGui&sFileName='
